        ...
        <div class="routine-container">
            <div class="routine-content">
                ...
                <div class="days-wrapper">
                    <div v-for="day in [1,2,3,4,5,6,7]"
                         :key="day"
                         class="day-card">
                        <h2>
                            {{ ['Pirmdiena','Otrdiena','Trešdiena','Ceturtdiena','Piektdiena','Sestdiena','Svētdiena'][day - 1] }}
                        </h2>

                        <template v-if="safeRoutine.exercises.filter(e => e.pivot?.day_number === day).length">
                            <div v-for="exercise in safeRoutine.exercises.filter(e => e.pivot?.day_number === day)"
                                 :key="exercise.id"
                                 class="exercise-card">
                                ...
                                <p v-if="exercise.pivot?.notes" class="exercise-notes">
                                    Piezīmes: {{ exercise.pivot.notes }}
                                </p>
                            </div>
                        </template>
                        <p v-else class="rest-day">Atpūtas diena</p>
                    </div>
                </div>
            </div>
        </div>
