...
const cancel = () => router.get(route('routines.my'));

const name        = ref(props.routine.name);
const description = ref(props.routine.description || '');
const is_public   = ref(props.routine.is_public || false);
...
if (props.routine.exercises) {
    props.routine.exercises.forEach(ex => {
        const dayNum = ex.pivot?.day_number || 1;
...
const submit = () => {
    const exercises = days.value.flatMap(day =>
        day.exercises
            .filter(ex => ex.id)
            .map(ex => ({
                id:         ex.id,
    ...
    router.put(route('routines.update', { routine: props.routine.id }), {
        name:        name.value,
        ...
        <div class="edit-routine-page">
            <div class="container">
                ...
                <div class="page-header">
                    ...
                    <h1 class="page-title">Rediģēt rutīnu</h1>
                    <p class="page-subtitle">{{ routine.name }}</p>
                </div>
                ...
                <form @submit.prevent="submit" class="routine-form">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea v-model="description" rows="4" class="form-textarea"
                                          placeholder="Apraksti savus treniņa mērķus..."></textarea>
                            </div>

                            <div class="form-group checkbox-group">
                                <label class="checkbox-label">
                                    <input type="checkbox" v-model="is_public" class="checkbox-input" />
                    ...
                    <div class="form-section">
                        ...
                        <div class="days-grid">
                            <div class="day-card" v-for="day in days" :key="day.day_number">
